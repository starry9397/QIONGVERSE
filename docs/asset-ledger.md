...
| `public/assets/user-media2/*-hall-banner-01.webp` | Five WebP derivatives for the homepage wheel's active visual and carousel | Homepage active hall visual only; original banners remain the high-resolution fallback/source for immersive hall contexts | Supplied project media delivery derivative; no new content claim | Original hall banner, then poster |
| `public/assets/hero/qiongverse-hero2.webp`, `public/assets/brand/*.webp`, `public/assets/user-media2/自贸港主厅/自贸港建设图.webp` | Non-destructive WebP delivery derivatives for the first viewport, global brand lockup, footer mark, and Free Trade Port portal background | Responsive image sources; original JPEG/PNG files remain as fallback/source | Supplied project media delivery derivative; no new content claim | Original JPEG/PNG path |
| `public/assets/luoyin/luoyin-resonance-deskpet.webp` | Transparent WebP delivery derivative of the 2D Luoyin desktop pet | Global fictional guide trigger | Original fictional project guide delivery derivative; original transparent PNG retained | Labelled text trigger and chat panel |
