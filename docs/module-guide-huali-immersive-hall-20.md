...
| --- | --- | --- | --- |
| `assets/3d/countryside/countryside world.spz` | Route-loaded immersive world | `东方花梨展厅参考图.png` | Project asset |
| `assets/3d/countryside/东方花梨展厅参考图.png` | WebGL/load/timeout fallback | Exhibit index remains usable | Project asset |
