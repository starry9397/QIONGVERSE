  ...
  useEffect(() => {
    ...
    void (async () => {
      try {
        ...
        avatar = createLuoyinAvatarController({ scene, camera, renderer, controls, splat, config: avatarWorldConfigs.huali, onState: setAvatarState }); avatarRef.current = avatar
