...
function App() {
  ...
  const [activeHall, setActiveHall] = useState<'limiao' | 'aerospace' | 'huali' | 'village' | 'freeTradePort' | null>(() => window.location.hash === '#limiao-hall' ? 'limiao' : window.location.hash === '#aerospace-hall' ? 'aerospace' : window.location.hash === '#huali-hall' ? 'huali' : window.location.hash === '#village-hall' ? 'village' : window.location.hash === '#free-trade-hall' ? 'freeTradePort' : null)
  ...
  useEffect(() => {
    const syncHallRoute = () => setActiveHall(window.location.hash === '#limiao-hall' ? 'limiao' : window.location.hash === '#aerospace-hall' ? 'aerospace' : window.location.hash === '#huali-hall' ? 'huali' : window.location.hash === '#village-hall' ? 'village' : window.location.hash === '#free-trade-hall' ? 'freeTradePort' : null)
